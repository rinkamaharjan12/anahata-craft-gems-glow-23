...
const Footer = () => {
  return (
    <footer className="bg-anahata-brown text-white">
                  ...
                  <li key={link.name}>
                    <a 
                      ...
                      className={cn(
                        ...
                        "inline-block after:content-[''] after:block after:w-0 after:h-0.5",
                        "after:bg-anahata-terracotta hover:after:w-full after:transition-all"
                      )}
                    >
                      {link.name}
                    </a>
